...
wire [31:0] wb_m2s_mapper0_adr;
wire [31:0] wb_m2s_mapper0_dat;
wire  [3:0] wb_m2s_mapper0_sel;
wire        wb_m2s_mapper0_we;
wire        wb_m2s_mapper0_cyc;
wire        wb_m2s_mapper0_stb;
wire  [2:0] wb_m2s_mapper0_cti;
wire  [1:0] wb_m2s_mapper0_bte;
wire [31:0] wb_s2m_mapper0_dat;
wire        wb_s2m_mapper0_ack;
wire        wb_s2m_mapper0_err;
wire        wb_s2m_mapper0_rty;
...
wb_intercon wb_intercon0
   (.wb_clk_i         (wb_clk),
    .wb_rst_i         (wb_rst),
    .wb_mapper0_adr_i (wb_m2s_mapper0_adr),
    .wb_mapper0_dat_i (wb_m2s_mapper0_dat),
    .wb_mapper0_sel_i (wb_m2s_mapper0_sel),
    .wb_mapper0_we_i  (wb_m2s_mapper0_we),
    .wb_mapper0_cyc_i (wb_m2s_mapper0_cyc),
    .wb_mapper0_stb_i (wb_m2s_mapper0_stb),
    .wb_mapper0_cti_i (wb_m2s_mapper0_cti),
    .wb_mapper0_bte_i (wb_m2s_mapper0_bte),
    .wb_mapper0_dat_o (wb_s2m_mapper0_dat),
    .wb_mapper0_ack_o (wb_s2m_mapper0_ack),
    .wb_mapper0_err_o (wb_s2m_mapper0_err),
    .wb_mapper0_rty_o (wb_s2m_mapper0_rty),
