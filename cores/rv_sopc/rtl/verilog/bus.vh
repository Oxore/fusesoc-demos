...
wire [31:0] wb_m2s_picorv320_adr;
wire [31:0] wb_m2s_picorv320_dat;
wire  [3:0] wb_m2s_picorv320_sel;
wire        wb_m2s_picorv320_we;
wire        wb_m2s_picorv320_cyc;
wire        wb_m2s_picorv320_stb;
wire  [2:0] wb_m2s_picorv320_cti;
wire  [1:0] wb_m2s_picorv320_bte;
wire [31:0] wb_s2m_picorv320_dat;
wire        wb_s2m_picorv320_ack;
wire        wb_s2m_picorv320_err;
wire        wb_s2m_picorv320_rty;
...
wb_bus wb_bus0
   (.wb_clk_i           (wb_clk),
    .wb_rst_i           (wb_rst),
    .wb_picorv320_adr_i (wb_m2s_picorv320_adr),
    .wb_picorv320_dat_i (wb_m2s_picorv320_dat),
    .wb_picorv320_sel_i (wb_m2s_picorv320_sel),
    .wb_picorv320_we_i  (wb_m2s_picorv320_we),
    .wb_picorv320_cyc_i (wb_m2s_picorv320_cyc),
    .wb_picorv320_stb_i (wb_m2s_picorv320_stb),
    .wb_picorv320_cti_i (wb_m2s_picorv320_cti),
    .wb_picorv320_bte_i (wb_m2s_picorv320_bte),
    .wb_picorv320_dat_o (wb_s2m_picorv320_dat),
    .wb_picorv320_ack_o (wb_s2m_picorv320_ack),
    .wb_picorv320_err_o (wb_s2m_picorv320_err),
    .wb_picorv320_rty_o (wb_s2m_picorv320_rty),
