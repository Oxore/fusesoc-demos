...
module wb_bus
   (input         wb_clk_i,
    input         wb_rst_i,
    input  [31:0] wb_picorv320_adr_i,
    input  [31:0] wb_picorv320_dat_i,
    input   [3:0] wb_picorv320_sel_i,
    input         wb_picorv320_we_i,
    input         wb_picorv320_cyc_i,
    input         wb_picorv320_stb_i,
    input   [2:0] wb_picorv320_cti_i,
    input   [1:0] wb_picorv320_bte_i,
    output [31:0] wb_picorv320_dat_o,
    output        wb_picorv320_ack_o,
    output        wb_picorv320_err_o,
    output        wb_picorv320_rty_o,
...
wb_mux
  #(.num_slaves (2),
    ...
    .MATCH_MASK ({32'hffffc000, 32'hfffffffe}))
 wb_mux_picorv320
   (.wb_clk_i  (wb_clk_i),
    .wb_rst_i  (wb_rst_i),
    .wbm_adr_i (wb_picorv320_adr_i),
    .wbm_dat_i (wb_picorv320_dat_i),
    .wbm_sel_i (wb_picorv320_sel_i),
    .wbm_we_i  (wb_picorv320_we_i),
    .wbm_cyc_i (wb_picorv320_cyc_i),
    .wbm_stb_i (wb_picorv320_stb_i),
    .wbm_cti_i (wb_picorv320_cti_i),
    .wbm_bte_i (wb_picorv320_bte_i),
    .wbm_dat_o (wb_picorv320_dat_o),
    .wbm_ack_o (wb_picorv320_ack_o),
    .wbm_err_o (wb_picorv320_err_o),
    .wbm_rty_o (wb_picorv320_rty_o),
